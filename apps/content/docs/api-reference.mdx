...
| Package | Purpose | Related Guides |
| ------- | ------- | -------------- |
| [@orpc/zod](https://npmx.dev/package-docs/@orpc/zod) | JSON Schema converter for Zod. | [Zod](/docs/integrations/zod) |
| [@orpc/valibot](https://npmx.dev/package-docs/@orpc/valibot) | JSON Schema converter for Valibot. | [Valibot](/docs/integrations/valibot) |
| [@orpc/arktype](https://npmx.dev/package-docs/@orpc/arktype) | JSON Schema converter for ArkType. | [ArkType](/docs/integrations/arktype) |
